...
EvaluationOfTemporalRelations_ImplBase{
	...
	public static void main(String[] args) throws Exception {
		...
		try{
			...
			EvaluationOfEventEventCRFRelations evaluation = new EvaluationOfEventEventCRFRelations(
					workingDir,
...
//			System.err.println(params.stats);
	...
	public EvaluationOfEventEventCRFRelations(
			File baseDirectory,
...
//		aggregateBuilder.add(AnalysisEngineFactory.createEngineDescription(AddEEPotentialRelations.class));
		...
		JarClassifierBuilder.trainAndPackage(new File(directory,"event-event"),new String[]{"-p", "c2=" + "0.3"});
	}
